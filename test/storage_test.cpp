...
//   storage.initialize_with_schema_file(LOCAL_SCHEMA_PATH);
...
TEST_CASE("save initialized pm", CATCH_CATEGORY) {
  PatchMaster *pm = PatchMaster_instance();
  fprintf(stderr, "test: orig pm instance %p\n", pm); // DEBUG
  ...
  fprintf(stderr, "creating new pm\n"); // DEBUG
  pm = new PatchMaster();
